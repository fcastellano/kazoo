...
matching_rate(Rate, <<"ratedeck">>, JObj) ->
    AccountId = kz_json:get_value(<<"Account-ID">>, JObj),
    AccountRatedeck = kz_service_ratedeck:get_ratedeck(AccountId),
    RatedeckId = kz_json:get_value(<<"ratedeck">>, Rate),
    AccountRatedeck =:= RatedeckId;
